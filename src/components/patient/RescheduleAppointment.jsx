...
function RescheduleAppointment({ appointment, onClose, onReschedule, apiBase }) {
  ...
  useEffect(() => {
    ...
    fetch(`${apiBase}/api/patient/doctor/${appointment.doctorId}/slots`, {
      headers: {
  ...
  const handleSubmit = () => {
    ...
    fetch(
      `${apiBase}/api/patient/appointments/${appointment.appointmentId}/reschedule?newSlotId=${selectedSlot.id}&reason=${encodeURIComponent(
        reason
      )}`,
      {
        method: "PUT",
