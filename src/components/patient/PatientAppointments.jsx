...
// function PatientAppointments() {
//   const [view, setView] = useState("book"); // default to "book"
//   const [doctors, setDoctors] = useState([]);
//   const [searchKeyword, setSearchKeyword] = useState("");
//   const [selectedDoctor, setSelectedDoctor] = useState(null);
//   const [slots, setSlots] = useState([]);
...
//   // Fetch all doctors automatically on component mount
//   useEffect(() => {
//     fetchDoctors();
//   }, []);
...
//         icon: "error",
//         title: "Error",
//         text: "Error fetching doctors: " + err.message,
//      });
...
//       text: "Please select a slot and enter a reason.",
//     });
//   }
//   try {
//     const res = await fetch(
//       `${API_BASE}/api/patient/book-appointment/${selectedSlot.id}?reason=${encodeURIComponent(
//         reason
//       )}`,
//       {
//         method: "POST",
...
//       icon: "error",
//       title: "Error",
//       text: "Error booking appointment: " + err.message,
//     });
//   }
// };
...
//   // const filteredDoctors = searchKeyword
//   //   ? doctors.filter((doc) =>
...
//                   <div><b>Dr. {doc.name.toUpperCase()}</b></div>
//                   <div><strong>Specialization:</strong> {capitalize(doc.specialization)}</div>
//                   <div><strong>Hospital:</strong>{capitalize(doc.hospital)}</div><br></br>
//                 </div>
//                 <button
//                   className="btn-ghost"
//                   onClick={() => {
...
//                     <div className="selected-slot">
//                       <p>
//                         Selected: {formatDate(selectedSlot.slotDate)}{" "}
//                         {formatTime(selectedSlot.startTime)}
//                       </p>
//                       {/* <div className="slots">
//                         {slots.map((slot) => (
//                           <button key={slot.id} className={`slot-chip ${selectedSlot?.id === slot.id ? "selected" : ""}`} onClick={() => setSelectedSlot(slot)}>
//                             <div>{formatDate(slot.slotDate)}</div>
//                             <div>{formatTime(slot.startTime)}</div>
//                           </button>
//                         ))}
